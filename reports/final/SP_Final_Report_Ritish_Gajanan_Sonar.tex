...
\begin{titlepage}
    ...
    \begin{flushleft}
    \textbf{Author:} Ritish Gajanan Sonar\\[0.3cm]
    ...
    \textbf{Team:} Akshay Rukade, J Krithika and Ritish Gajanan Sonar
    \end{flushleft}
...
This was a three-member group project (Akshay Rukade, J Krithika and Ritish Gajanan Sonar). The work was divided by module;
integration debugging and the experiment scripts were shared. My own contribution
(Ritish Gajanan Sonar, synchronisation, testing, audio I/O and dashboard):
