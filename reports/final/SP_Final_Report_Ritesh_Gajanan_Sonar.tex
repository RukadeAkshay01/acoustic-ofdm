...
\begin{titlepage}
    ...
    \begin{flushleft}
    \textbf{Author:} Ritesh Gajanan Sonar\\[0.3cm]
    \textbf{Roll Number:} 23F3000249\\[0.3cm]
    \textbf{Project Code (if any):} Custom (self-proposed)\\[0.3cm]
    \textbf{Submission Date:} 25-09-2026\\[0.3cm]
    \textbf{Instructor:} \fillin{Instructor Name}\\[0.3cm]
    \textbf{Team Members:} \begin{tabular}[t]{@{}l@{}}Akshay Ajit Rukade --- 24F2100357 \\ J Krithika --- 24F2100165 \\ Ritesh Gajanan Sonar --- 23F3000249\end{tabular}
    \end{flushleft}
...
\begin{itemize}
    ...
    [2].
    \item \textbf{Clipping and filtering} for OFDM PAPR reduction [4].
    \item \textbf{Sampling-clock offset} in OFDM appears as a phase rotation
    proportional to subcarrier index and growing with time [5].
...
This was a three-member group project (Akshay Ajit Rukade, J Krithika and Ritesh Gajanan Sonar). The work was divided by module;
integration debugging and the experiment scripts were shared. My own contribution
(Ritesh Gajanan Sonar, synchronisation, testing, audio I/O and dashboard):
...
\begin{enumerate}
    ...
    \item J. Armstrong, ``Peak-to-average power reduction for OFDM by repeated clipping and frequency domain filtering,'' \textit{Electronics Letters}, vol. 38, no. 5, pp. 246--247, 2002.
    \item M. Speth, S. A. Fechtel, G. Fock and H. Meyr, ``Optimum receiver design for wireless broad-band systems using OFDM---Part I,'' \textit{IEEE Trans. Communications}, vol. 47, no. 11, pp. 1668--1677, 1999.
    \item A. J. Viterbi, ``Error bounds for convolutional codes and an asymptotically optimum decoding algorithm,'' \textit{IEEE Trans. Information Theory}, vol. 13, no. 2, pp. 260--269, 1967.
